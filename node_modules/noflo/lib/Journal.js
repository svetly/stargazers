(function() {
  ...
  Journal = (function(_super) {
    ...
    function Journal(graph, metadata, store) {
      ...
      this.graph.on('changeNode', function(node, oldMeta) {
      ...
      this.graph.on('changeEdge', function(edge, oldMeta) {
      ...
      this.graph.on('changeProperties', function(newProps, oldProps) {
        return _this.appendCommand('changeProperties', {
          "new": newProps,
          old: oldProps
        });
      });
      this.graph.on('addGroup', function(group) {
        return _this.appendCommand('addGroup', group);
      });
      this.graph.on('renameGroup', function(oldName, newName) {
        return _this.appendCommand('renameGroup', {
          oldName: oldName,
          newName: newName
        });
      });
      this.graph.on('removeGroup', function(group) {
        return _this.appendCommand('removeGroup', group);
      });
      this.graph.on('changeGroup', function(group, oldMeta) {
      ...
      this.graph.on('addExport', function(exported) {
        return _this.appendCommand('addExport', exported);
      });
      this.graph.on('removeExport', function(exported) {
        return _this.appendCommand('removeExport', exported);
      });
      this.graph.on('addInport', function(name, port) {
        return _this.appendCommand('addInport', {
          name: name,
          port: port
        });
      });
      this.graph.on('removeInport', function(name, port) {
        return _this.appendCommand('removeInport', {
          name: name,
          port: port
        });
      });
      this.graph.on('renameInport', function(oldId, newId) {
        return _this.appendCommand('renameInport', {
          oldId: oldId,
          newId: newId
        });
      });
      this.graph.on('changeInport', function(name, port, oldMeta) {
      ...
      this.graph.on('addOutport', function(name, port) {
        return _this.appendCommand('addOutport', {
          name: name,
          port: port
        });
      });
      this.graph.on('removeOutport', function(name, port) {
        return _this.appendCommand('removeOutport', {
          name: name,
          port: port
        });
      });
      this.graph.on('renameOutport', function(oldId, newId) {
        return _this.appendCommand('renameOutport', {
          oldId: oldId,
          newId: newId
        });
      });
      this.graph.on('changeOutport', function(name, port, oldMeta) {
      ...
      this.graph.on('startTransaction', function(id, meta) {
        return _this.startTransaction(id, meta);
      });
      this.graph.on('endTransaction', function(id, meta) {
